#! /bin/bash
figlet T M P S F S F P
    


    echo "                               By Rakan"
    
   # echo "                https://sa.linkedin.com/in/rakan-al-khaled-50416a209?trk=public_profile_browsemap"



    echo "      An example of a run command | ./c4-403.sh https://c4.sa path"
    echo " "
